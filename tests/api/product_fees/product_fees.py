...
def test_get_fees_for_sku():
    res = ProductFees().get_product_fees_estimate_for_sku(
        "UmaS1",
        10,
        currency="USD",
        shipping_price=10,
...
def test_get_fees_for_asin():
    res = ProductFees().get_product_fees_estimate_for_asin(
        "UmaS1",
        10,
        currency="USD",
        shipping_price=10,
...
def test_get_product_fees_estimate():
    res = ProductFees().get_product_fees_estimate(
        [
            ...
            dict(
                identifier="UmaS2",
                marketplace_id=Marketplaces.MX.marketplace_id,
                id_type="SellerSKU",
                id_value="sku123",
                price=10,
                currency="MXN",
                ...
                points={
                    "PointsNumber": 0,
                    "PointsMonetaryValue": {"CurrencyCode": "MXN", "Amount": 0},
                },
            ),
        ]
    )
