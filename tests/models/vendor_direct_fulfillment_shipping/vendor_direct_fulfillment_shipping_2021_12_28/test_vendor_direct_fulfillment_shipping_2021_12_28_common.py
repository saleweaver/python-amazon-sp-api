...
from sp_api.api.models.vendor_direct_fulfillment_shipping.vendor_direct_fulfillment_shipping_2021_12_28.common import (
    Address, Container, ContainerLabel, ContainerTypeEnum, ContentTypeEnum,
    ...
    Dimensions, Error, ErrorList, GetCustomerInvoiceRequest,
    GetCustomerInvoicesRequest, GetPackingSlipRequest, GetPackingSlipsRequest,
    GetRequestSerializer, GetShippingLabelRequest, GetShippingLabelsRequest,
    Item, ItemQuantity, LabelData, LabelFormatEnum, Package, PackedItem,
    PackingSlip, PackingSlipList, Pagination, PartyIdentification,
    RequestsBaseModel, ShipmentConfirmation, ShipmentDetails, ShipmentSchedule,
