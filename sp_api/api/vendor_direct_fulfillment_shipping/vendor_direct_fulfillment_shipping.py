...
The x-amzn-RateLimit-Limit response header returns the usage plan rate limits that were applied to the requested operation. Rate limits for some selling partners will vary from the default rate and burst shown in the table above. For more information, see "Usage Plans and Rate Limits" in the Selling Partner API documentation.
         ...
         Args:
            ...
            body: | * REQUIRED {'properties': {'shippingLabelRequests': {'items': {'$ref': '#/definitions/ShippingLabelRequest'}, 'type': 'array'}}, 'type': 'object'}
...
The x-amzn-RateLimit-Limit response header returns the usage plan rate limits that were applied to the requested operation. Rate limits for some selling partners will vary from the default rate and burst shown in the table above. For more information, see "Usage Plans and Rate Limits" in the Selling Partner API documentation.
         ...
         Args:
            ...
            body: | * REQUIRED {'properties': {'shipmentConfirmations': {'items': {'$ref': '#/definitions/ShipmentConfirmation'}, 'type': 'array'}}, 'type': 'object'}
...
The x-amzn-RateLimit-Limit response header returns the usage plan rate limits that were applied to the requested operation. Rate limits for some selling partners will vary from the default rate and burst shown in the table above. For more information, see "Usage Plans and Rate Limits" in the Selling Partner API documentation.
         ...
         Args:
            ...
            body: | * REQUIRED {'properties': {'shipmentStatusUpdates': {'items': {'$ref': '#/definitions/ShipmentStatusUpdate'}, 'minItems': 1, 'type': 'array'}}, 'type': 'object'}
