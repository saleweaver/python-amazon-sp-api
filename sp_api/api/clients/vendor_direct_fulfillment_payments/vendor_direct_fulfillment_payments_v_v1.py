...
# Import all models
from sp_api.api.models.vendor_direct_fulfillment_payments.vendor_direct_fulfillment_payments_v1 import *
from sp_api.base import ApiResponse, Client, fill_query_params, sp_endpoint

T = TypeVar("T")


class VendorDirectFulfillmentPayments_V_v1(Client):
    """
    Selling Partner API for Direct Fulfillment Payments - v1
