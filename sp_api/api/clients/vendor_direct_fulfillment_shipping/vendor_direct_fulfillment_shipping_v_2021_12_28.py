...
# Import all models
from sp_api.api.models.vendor_direct_fulfillment_shipping.vendor_direct_fulfillment_shipping_2021_12_28 import *
from sp_api.base import ApiResponse, Client, fill_query_params, sp_endpoint

T = TypeVar("T")


class VendorDirectFulfillmentShipping_V_2021_12_28(Client):
    """
    Selling Partner API for Direct Fulfillment Shipping - 2021-12-28
    ...
    def get_shipping_labels(self, *args, **kwargs) -> ApiResponse[ShippingLabelList]:
        """
        Returns a list of shipping labels created during the time frame that you specify. Use the `createdAfter` and `createdBefore` parameters to define the time frame. You must use both of these parameters. The date range to search must not be more than seven days.
        ...
        **Usage Plan:**
        ...
        return self._request(
            path, query=query, body=body, method=method, _type=ShippingLabelList
        )
    ...
    @sp_endpoint(
        "/vendor/directFulfillment/shipping/2021-12-28/shippingLabels", method="POST"
    )
    def submit_shipping_label_request_body(
        self, *args, **kwargs
    ) -> ApiResponse[TransactionReference]:
    ...
    def get_shipping_label(self, *args, **kwargs) -> ApiResponse[ShippingLabel]:
        """
        Returns a shipping label for the `purchaseOrderNumber` that you specify.
        ...
        **Usage Plan:**
        ...
        return self._request(
            path, query=query, body=body, method=method, _type=ShippingLabel
        )

    @overload
    def create_shipping_labels(
        self, request: CreateShippingLabelsRequest, *args, **kwargs
    ) -> ApiResponse[ShippingLabel]:
        """
    ...
    def create_shipping_labels(self, *args, **kwargs) -> ApiResponse[ShippingLabel]:
        """
        Creates shipping labels for a purchase order and returns the labels.
        ...
        **Usage Plan:**
        ...
        method = kwargs.pop("method")
        request = args[0]
        if not isinstance(request, CreateShippingLabelsRequest):
            request = CreateShippingLabelsRequest(**kwargs)
        path, body, query = request.create_request(path, self.marketplace_id)
    ...
    def get_customer_invoices(
        ...
        **Usage Plan:**
        ...
        return self._request(
            path, query=query, body=body, method=method, _type=CustomerInvoiceList
        )
    ...
    def get_customer_invoice(self, *args, **kwargs) -> ApiResponse[CustomerInvoice]:
        """
        Returns a customer invoice based on the purchaseOrderNumber that you specify.
        ...
        **Usage Plan:**
        ...
        return self._request(
            path, query=query, body=body, method=method, _type=CustomerInvoice
        )
    ...
    @sp_endpoint(
        "/vendor/directFulfillment/shipping/2021-12-28/packingSlips", method="GET"
    )
    def get_packing_slips(self, *args, **kwargs) -> ApiResponse[PackingSlipList]:
        """
        Returns a list of packing slips for the purchase orders that match the criteria specified. Date range to search must not be more than 7 days.
        ...
        **Usage Plan:**
        ...
        return self._request(
            path, query=query, body=body, method=method, _type=PackingSlipList
        )
    ...
    def get_packing_slip(self, *args, **kwargs) -> ApiResponse[PackingSlip]:
        """
        Returns a packing slip based on the purchaseOrderNumber that you specify.
        ...
        **Usage Plan:**
        ...
        return self._request(
            path, query=query, body=body, method=method, _type=PackingSlip
        )

    @overload
    def create_container_label(
        self, request: CreateContainerLabelRequest, *args, **kwargs
    ...
    @sp_endpoint(
        "/vendor/directFulfillment/shipping/2021-12-28/containerLabel", method="POST"
    )
    def create_container_label(
        self, *args, **kwargs
    ) -> ApiResponse[CreateContainerLabelResponse]:
        ...
        **Usage Plan:**
        ...
        method = kwargs.pop("method")
        request = args[0]
        if not isinstance(request, CreateContainerLabelRequest):
            request = CreateContainerLabelRequest(**kwargs)
        path, body, query = request.create_request(path, self.marketplace_id)
        ...
        return self._request(
            ...
            body=body,
            method=method,
            _type=CreateContainerLabelResponse,
        )
