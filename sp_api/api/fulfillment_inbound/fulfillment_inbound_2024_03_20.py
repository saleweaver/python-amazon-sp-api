...
class FulfillmentInboundV20240320(Client):
    """
    ...
    def get_delivery_challan_document(
        ...
        return self.get_delivery_challan_document_get(
    ...
    def get_self_ship_appointment_slots(
        ...
        return self.get_self_ship_appointment_slots_get(
            inboundPlanId, shipmentId, **kwargs
        )
    ...
    def generate_self_ship_appointment_slots(
        ...
        return self.generate_self_ship_appointment_slots_post(
            inboundPlanId, shipmentId, **kwargs
        )
    ...
    def schedule_self_ship_appointment(
        ...
        return self.schedule_self_ship_appointment_post(
    ...
    def update_shipment_tracking_details(self, inboundPlanId, **kwargs) -> ApiResponse:
        ...
        Examples:
            literal blocks::
                ...
                FulfillmentInboundV20240320().update_shipment_tracking_details("value")
    ...
    def update_inbound_plan_name(self, inboundPlanId, **kwargs) -> ApiResponse:
        """
    ...
    def list_packing_group_boxes(self, inboundPlanId, packingGroupId, **kwargs) -> ApiResponse:
        """
    ...
    def list_shipment_content_update_previews(self, inboundPlanId, shipmentId, **kwargs) -> ApiResponse:
        """
    ...
    def generate_shipment_content_update_previews(self, inboundPlanId, shipmentId, **kwargs) -> ApiResponse:
        """
    ...
    @sp_endpoint("/inbound/fba/2024-03-20/inboundPlans/{}/shipments/{}/contentUpdatePreviews/{}", method="GET")
    def get_shipment_content_update_preview(self, inboundPlanId, shipmentId, contentUpdatePreviewId, **kwargs) -> ApiResponse:
        """
        ...
        Returns:
            ApiResponse
        """
        return self._request(fill_query_params(kwargs.pop("path"), inboundPlanId, shipmentId, contentUpdatePreviewId), params=kwargs)

    @sp_endpoint("/inbound/fba/2024-03-20/inboundPlans/{}/shipments/{}/contentUpdatePreviews/{}/confirmation", method="POST")
    def confirm_shipment_content_update_preview(self, inboundPlanId, shipmentId, contentUpdatePreviewId, **kwargs) -> ApiResponse:
        """
        ...
        Returns:
            ApiResponse
        """
        return self._request(fill_query_params(kwargs.pop("path"), inboundPlanId, shipmentId, contentUpdatePreviewId), data=kwargs)

    @sp_endpoint("/inbound/fba/2024-03-20/inboundPlans/{}/shipments/{}/deliveryChallanDocument", method="GET")
    def get_delivery_challan_document_get(self, inboundPlanId, shipmentId, **kwargs) -> ApiResponse:
        """
    ...
    def list_shipment_pallets(self, inboundPlanId, shipmentId, **kwargs) -> ApiResponse:
        """
    ...
    def cancel_self_ship_appointment_put(self, inboundPlanId, shipmentId, **kwargs) -> ApiResponse:
        """
    ...
    def cancel_self_ship_appointment(self, inboundPlanId, shipmentId, **kwargs) -> ApiResponse:
        """
        ...
        """
        return self.cancel_self_ship_appointment_put(inboundPlanId, shipmentId, **kwargs)

    @sp_endpoint("/inbound/fba/2024-03-20/inboundPlans/{}/shipments/{}/selfShipAppointmentSlots", method="GET")
    def get_self_ship_appointment_slots_get(self, inboundPlanId, shipmentId, **kwargs) -> ApiResponse:
        """
    ...
    def generate_self_ship_appointment_slots_post(self, inboundPlanId, shipmentId, **kwargs) -> ApiResponse:
        """
    ...
    def schedule_self_ship_appointment_post(self, inboundPlanId, shipmentId, slotId, **kwargs) -> ApiResponse:
        """
        ...
        Returns:
            ApiResponse
        """
        return self._request(fill_query_params(kwargs.pop("path"), inboundPlanId, shipmentId, slotId), data=kwargs)
