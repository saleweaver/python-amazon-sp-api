...
class Products(Client):
    ...
    def get_item_offers_batch(self, requests_: Optional[Union[List[Dict], GetItemOffersBatchRequest]] = None,
                              **kwargs) -> ApiResponse:
        """
        get_item_offers_batch(self, requests_: Optional[List[Union[Dict, GetItemOffersBatchRequest]]], **kwargs) -> ApiResponse
    ...
    def get_listing_offers_batch(self, requests_: Optional[Union[List[Dict], GetListingOffersBatchRequest]] = None,
                                 **kwargs) -> ApiResponse:
        """
        get_listing_offers_batch(self, requests_: Optional[List[Union[Dict, GetListingOffersBatchRequest]]], **kwargs) -> ApiResponse
