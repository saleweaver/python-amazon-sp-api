...
class GetTransactionRequest(GetRequestSerializer, RequestsBaseModel):
    ...
    transaction_id: Annotated[
        ...
        Field(
            ...
            description="[PATH] The GUID provided by Amazon in the 'transactionId' field in response to the post request of a specific transaction.",
        ),
    ]
...
class GetTransactionResponse(SpApiBaseModel):
    ...
    payload: Annotated[
        ...
        Field(
            None, description="The response payload for the getTransaction operation."
        ),
    ]
