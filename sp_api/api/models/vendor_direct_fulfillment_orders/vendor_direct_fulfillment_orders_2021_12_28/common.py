...
class TaxItemDetails(SpApiBaseModel):
    """Total tax details for the line item."""
    ...
    tax_line_item: Annotated[
        Optional["TaxLineItem"],
        Field(
            None,
            validation_alias=AliasChoices("taxLineItem", "tax_line_item"),
            serialization_alias="taxLineItem",
...
class buyerCustomizedInfoDetail(SpApiBaseModel):
    ...
    customized_url: Annotated[
        Optional[str],
        Field(
            None,
            validation_alias=AliasChoices("customizedUrl", "customized_url"),
