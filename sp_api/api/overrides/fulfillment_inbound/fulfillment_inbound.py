...
from sp_api.base import (ApiResponse, Client, Marketplaces, fill_query_params,
                         sp_endpoint)
...
class FulfillmentInbound(Client):
    ...
    @sp_endpoint(
        "/inbound/fba/<version>/inboundPlans/{}/packingGroups/{}/items", method="GET"
    )
    def list_packing_group_items(
        self, inboundPlanId, packingGroupId, **kwargs
    ) -> ApiResponse:
        """
        ...
        **Usage Plan:**
        ...
        return self._request(
            fill_query_params(kwargs.pop("path"), inboundPlanId, packingGroupId),
            params=kwargs,
        )
