...
class ExternalFulfillmentShippingV20240911(AsyncBaseClient):
    """
    ...
    async def get_shipments(self, **kwargs) -> ApiResponse:
        ...
        Examples:
            literal blocks::
                ...
                await ExternalFulfillmentShippingV20240911().get_shipments()
    ...
    async def get_shipment(self, shipmentId, **kwargs) -> ApiResponse:
        ...
        Examples:
            literal blocks::
                ...
                await ExternalFulfillmentShippingV20240911().get_shipment("value")
    ...
    async def process_shipment(self, shipmentId, **kwargs) -> ApiResponse:
        """
        ...
        Examples:
            literal blocks::
                ...
                await ExternalFulfillmentShippingV20240911().process_shipment("value")
    ...
    async def create_packages(self, shipmentId, **kwargs) -> ApiResponse:
        ...
        Examples:
            literal blocks::
                ...
                await ExternalFulfillmentShippingV20240911().create_packages("value")
    ...
    async def update_package(self, shipmentId, packageId, **kwargs) -> ApiResponse:
        ...
        Examples:
            literal blocks::
                ...
                await ExternalFulfillmentShippingV20240911().update_package("value", "value")
        ...
        Returns:
            ApiResponse
        """
        return await self._request(fill_query_params(kwargs.pop("path"), shipmentId, packageId), data=kwargs, add_marketplace=False)
    ...
    async def update_package_status(self, shipmentId, packageId, **kwargs) -> ApiResponse:
        ...
        Examples:
            literal blocks::
                ...
                await ExternalFulfillmentShippingV20240911().update_package_status("value", "value")
    ...
    async def retrieve_shipping_options(self, shipmentId, **kwargs) -> ApiResponse:
        """
        ...
        Examples:
            literal blocks::
                ...
                await ExternalFulfillmentShippingV20240911().retrieve_shipping_options("value")
    ...
    async def generate_invoice(self, shipmentId, **kwargs) -> ApiResponse:
        ...
        Examples:
            literal blocks::
                ...
                await ExternalFulfillmentShippingV20240911().generate_invoice("value")
    ...
    async def retrieve_invoice(self, shipmentId, **kwargs) -> ApiResponse:
        ...
        Examples:
            literal blocks::
                ...
                await ExternalFulfillmentShippingV20240911().retrieve_invoice("value")
    ...
    async def generate_ship_labels(self, shipmentId, **kwargs) -> ApiResponse:
        """
        ...
        Examples:
            literal blocks::
                ...
                await ExternalFulfillmentShippingV20240911().generate_ship_labels("value")
